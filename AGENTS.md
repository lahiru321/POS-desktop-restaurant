...
(its AGENTS.md holds the SaaS architecture and conventions).
...
- `lumora_pos/AGENTS.md` — SaaS architecture, multi-tenancy, auth, money-path invariants · `CLAUDE.md` — the
  same guidance for Claude Code, keep the two in step ·
